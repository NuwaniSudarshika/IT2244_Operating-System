//writer process1
[nuwani@LAPTOP-2OMR359V ~]$ vi 02q1.c
[nuwani@LAPTOP-2OMR359V ~]$ chmod 633 02q1.c
[nuwani@LAPTOP-2OMR359V ~]$ gcc 02q1.c -o 02q1
[nuwani@LAPTOP-2OMR359V ~]$ ./02q1
Write Data: Apple
Data written in memory: Apple

[nuwani@LAPTOP-2OMR359V ~]$ more 02q1.c
#include<stdio.h>
#include<stdlib.h>
#include<string.h>
#include<sys/ipc.h>
...
//Reader
[nuwani@LAPTOP-2OMR359V ~]$ vi 02q2.c
[nuwani@LAPTOP-2OMR359V ~]$ chmod 644 02q2.c
[nuwani@LAPTOP-2OMR359V ~]$ gcc 02q2.c -o 02q2
[nuwani@LAPTOP-2OMR359V ~]$ ./02q2
Data read from memory: Apple

[nuwani@LAPTOP-2OMR359V ~]$ more 02q2.c
#include<stdio.h>
#include<stdlib.h>
#include<string.h>
#include<sys/ipc.h>
...
------------------------------------------------------------------------------------------------
[nuwani@LAPTOP-2OMR359V ~]$ vi 02q3.c
[nuwani@LAPTOP-2OMR359V ~]$ chmod 644 02q3.c
[nuwani@LAPTOP-2OMR359V ~]$ gcc 02q3.c -o 02q3
[nuwani@LAPTOP-2OMR359V ~]$ ./02q3
Child wrote: Hello from child
parent read: Hello from child
[nuwani@LAPTOP-2OMR359V ~]$ more 02q3.c
#include<stdio.h>
#include<stdlib.h>
#include<unistd.h>
#include<sys/mman.h>
