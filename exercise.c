[nuwani@LAPTOP-2OMR359V ~]$ vi 09q1.c
[nuwani@LAPTOP-2OMR359V ~]$ gcc 09q1.c -o 09q1
[nuwani@LAPTOP-2OMR359V ~]$ ./09q1
hello world #1
hello world #2
hello world #3

[nuwani@LAPTOP-2OMR359V ~]$ more 09q1.c
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
#include <string.h>
...
[nuwani@LAPTOP-2OMR359V ~]$ vi 09q2.c
[nuwani@LAPTOP-2OMR359V ~]$ gcc 09q2.c -o 09q2
[nuwani@LAPTOP-2OMR359V ~]$ ./09q2
Enter shape type (C-circle, T-triangle, S-square, R-rectangle):C
Enter the radius: 7
Calculated Area: 153.86
[nuwani@LAPTOP-2OMR359V ~]$ more 09q2.c
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
#include <string.h>
