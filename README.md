✅ Q4: Print Numbers Using Parent and Child Process and Compute Sum
File: 22q1.c
This program demonstrates process creation using fork() to divide work between a child and a parent process.
...
📌 Purpose:
To demonstrate how a task (printing and summing numbers) can be split between parent and child processes in Linux using fork().
